function Card() {
  return (
    <>
      <div className="container mx-auto px-2 hover:opacity-50 m-5">
        <div className="max-w-2xl bg-white border-2 border-gray-300 p-5 rounded-md tracking-wide shadow-lg">
          <div id="header" className="flex">
            <img alt="mountain" className="w-45 rounded-md border-2 border-gray-300 hidden md:block" src="https://picsum.photos/seed/picsum/200" />
